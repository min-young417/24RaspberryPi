...
# 비행기
num = [17, 15, 13, 15, 17, 17, 17, 15, 15, 15, 17, 20, 20,
	   17, 15, 13, 15, 17, 17, 17, 15, 15, 17, 15, 13]
sle = [0.9, 0.3, 0.6, 0.6, 0.6, 0.6, 1.2, 0.6, 0.6, 1.2, 0.6, 0.6, 1.2,
	   0.9, 0.3, 0.6, 0.6, 0.6, 0.6, 1.2, 0.6, 0.6, 0.6, 0.6, 2.4]
...
for i in range(len(num)):
	pwm.ChangeFrequency(feq[num[i]-1])
	time.sleep(sle[i])
